...
, function(e, t, o) {
    ...
    var i = o(8)
      ...
      , t = o.n(t)
      , o = o(9);
    n.a.VideoWorker = n.a.VideoWorker || i.default,
    Object(o.default)(),
    t()(function() {
    ...
    var r = 0
      ...
      , m = function() {
        ...
        (t = [{
            ...
            key: "parseURL",
            value: function(e) {
                var t, o, i, n, a, r = !(!(t = (t = e).match(/.*(?:youtu.be\/|v\/|u\/\w\/|embed\/|watch\?v=)([^#\&\?]*).*/)) || 11 !== t[1].length) && t[1], l = !(!(o = (o = e).match(/https?:\/\/(?:www\.|player\.)?vimeo.com\/(?:channels\/(?:\w+\/)?|groups\/([^\/]*)\/videos\/|album\/(\d+)\/video\/|video\/|)(\d+)(?:$|\/|\?)/)) || !o[3]) && o[3], s = (i = e,
            ...
            value: function(s) {
                ...
                p.$video ? s(p.$video) : p.onAPIready(function() {
                    var e, t, o, i, n, a, r, l;
                    p.$video || ((e = document.createElement("div")).style.display = "none"),
                    "youtube" === p.type && (p.playerOptions = {
                    ...
                    p.options.showControls || (p.playerOptions.playerVars.iv_load_policy = 3,
                    ...
                    p.playerOptions.events = {
                        onReady: function(t) {
                            ...
                            p.fire("ready", t),
                            p.options.loop && !p.options.endTime && (p.options.endTime = p.player.getDuration() - .1),
                        ...
                        onStateChange: function(e) {
                            p.options.loop && e.data === u.a.YT.PlayerState.ENDED && p.play(p.options.startTime),
                            t || e.data !== u.a.YT.PlayerState.PLAYING || (t = 1,
                            p.fire("started", e)),
                            e.data === u.a.YT.PlayerState.PLAYING && p.fire("play", e),
                            e.data === u.a.YT.PlayerState.PAUSED && p.fire("pause", e),
                            e.data === u.a.YT.PlayerState.ENDED && p.fire("ended", e),
                            e.data === u.a.YT.PlayerState.PLAYING ? o = setInterval(function() {
                                p.fire("timeupdate", e),
                    ...
                    (i = !p.$video) && ((n = document.createElement("div")).setAttribute("id", p.playerID),
                    e.appendChild(n),
                    document.body.appendChild(e)),
                    p.player = p.player || new u.a.YT.Player(p.playerID,p.playerOptions),
                    i && (p.$video = document.getElementById(p.playerID),
                    p.options.accessibilityHidden && (p.$video.setAttribute("tabindex", "-1"),
                    p.$video.setAttribute("aria-hidden", "true")),
                    p.videoWidth = parseInt(p.$video.getAttribute("width"), 10) || 1280,
                    p.videoHeight = parseInt(p.$video.getAttribute("height"), 10) || 720)),
                    "vimeo" === p.type && (p.playerOptions = {
                        dnt: 1,
                        id: p.videoID,
                        autopause: 0,
                        transparent: 0,
                    ...
                    "local" === p.type && (p.$video || (p.$video = document.createElement("video"),
                    p.options.showControls && (p.$video.controls = !0),
                    ...
                    Object.keys(p.videoID).forEach(function(e) {
                        ...
                        o = p.videoID[e],
                        i = "video/".concat(e),
                        (e = document.createElement("source")).src = o,
                        e.type = i,
                        t.appendChild(e)
                    })),
